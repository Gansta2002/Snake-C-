...
//Ставим картнинку titels
    Texture t;
    t.loadFromFile("C:/Users/Артур/Desktop/Paint/tiles.png");
    Sprite tiles(t);

    //Ставим картинку змейки
    Texture sn;
    sn.loadFromFile("C:/Users/Артур/Desktop/Paint/snake.png");
    Sprite snake(sn);

    //Ставим картинку яблоко
    Texture ap;
    ap.loadFromFile("C:/Users/Артур/Desktop/Paint/apple.png");
    Sprite apple(ap);

    //Ставим надпись gameover
    Texture go;
    go.loadFromFile("C:/Users/Артур/Desktop/Paint/gameover.png");
    Sprite gameover(go);
